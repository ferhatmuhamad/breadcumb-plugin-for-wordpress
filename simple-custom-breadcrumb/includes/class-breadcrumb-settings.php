...
class SCB_Breadcrumb_Settings
{
	...
	public function register_settings()
	{
		...
		// ---- Section: Alignment ----
		add_settings_section(
			'scb_section_alignment',
			esc_html__('Alignment', 'simple-custom-breadcrumb'),
			'__return_false',
			'simple-custom-breadcrumb'
		);
		...
		add_settings_field(
			'align',
			esc_html__('Align Items', 'simple-custom-breadcrumb'),
			array($this, 'render_select_field'),
			'simple-custom-breadcrumb',
			'scb_section_alignment',
			array(
				'id'      => 'align',
				'options' => array(
					'left'   => esc_html__('Left', 'simple-custom-breadcrumb'),
					'center' => esc_html__('Center', 'simple-custom-breadcrumb'),
					'right'  => esc_html__('Right', 'simple-custom-breadcrumb'),
				),
			)
		);
	...
	public function sanitize_options($input)
	{
		...
		$clean['align']  = in_array($input['align'] ?? 'left', $valid_align, true)
			? $input['align']
			: 'left';
